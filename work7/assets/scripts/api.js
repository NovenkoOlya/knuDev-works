...
export async function fetchWeatherData(city) {
    ...
    const url = `https://api.openweathermap.org/data/2.5/forecast?lat=${geoData.lat}&lon=${geoData.lon}&appid=${APIKey}&units=metric`
...
export async function fetchTodayWeather(city) {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?lat=${geoData.lat}&lon=${geoData.lon}&appid=${APIKey}&units=metric`
